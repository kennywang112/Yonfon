...
train <- train%>%subset(主要用途 == "其他" & 單價 < 4 | 主要用途 != "其他")
train <- train%>%subset(主要用途 == "集合住宅" & 單價 < 3.5 | 主要用途 != "集合住宅")
